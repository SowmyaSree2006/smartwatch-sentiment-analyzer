...
def train_classical_model():
    ...
    try:
        ...
        # Train multiple models with overfitting/underfitting prevention
        print("\n[7/7] Training and evaluating 3 ML models...")
        ...
        models_config = {
            ...
            'Logistic Regression': {
                'model': LogisticRegression(
                    max_iter=2000, 
                    random_state=42, 
                    C=0.5,  # Lower C = more regularization (prevent overfitting)
                    penalty='l2',
            ...
            'Random Forest': {
                'model': RandomForestClassifier(
                    n_estimators=150,  # More trees to prevent underfitting
                    random_state=42, 
                    max_depth=15,  # Limit depth to prevent overfitting (pruning)
                    min_samples_split=10,  # Pruning: require more samples to split
                    min_samples_leaf=5,  # Pruning: require more samples in leaf
